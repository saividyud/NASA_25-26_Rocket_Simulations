...
df = pd.read_csv(f'./Monte Carlo Sims FRR/Data Files/{wind_speed_input}_monte_carlo_parameters.csv')
...
pickler(data, f'./Monte Carlo Sims FRR/Data Files/{wind_speed_input}_monte_carlo_data.pkl')
pickler(events, f'./Monte Carlo Sims FRR/Data Files/{wind_speed_input}_monte_carlo_events.pkl')