...
# Descent times
t_drogue = 42.0975      # apogee -> 700 ft
t_main   = 39.2025      # 700 ft -> landing
...
for vw, vw_mph in zip(wind_speeds, wind_speeds_mph):
    ...
    results.append((vw_mph, x_drogue, x))

# Output
print("Wind (mph) | Drogue Drift (ft) | Total Drift (ft)")
print("-----------------------------------------------")
for r in results:
    print(f"{r[0]:>10} | {r[1]:>17.2f} | {r[2]:>15.2f}")